      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20">
          ...
          <div>
            ...
            {/* EPK Download — the PDF is generated by scripts/generate-epk.mjs
                straight into public/. Re-run that script after any band-info change. */}
            <div className="mt-8 p-6 bg-noir-800/50 border border-noir-700 rounded-lg">
              ...
              <a
                href="/fleetwood-music-city-epk.pdf"
                download="Fleetwood-Music-City-EPK.pdf"
