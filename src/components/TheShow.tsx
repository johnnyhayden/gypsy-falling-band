...
export default function TheShow() {
  return (
    <section id="show" className="bg-noir-900 py-24 md:py-32">
      <div className="mx-auto max-w-3xl px-6">
        <p className="font-body text-xs font-medium uppercase tracking-[0.3em] text-gold-400">
          The Show
        </p>

        <p className="mt-5 font-heading text-2xl leading-snug text-cream md:text-4xl">
        ...
        <WildflowerRule className="mx-auto my-10 h-auto w-[260px] text-graphite/55 md:w-[300px]" />
        ...
        <blockquote className="relative my-10 pl-7">
          <span
            aria-hidden="true"
